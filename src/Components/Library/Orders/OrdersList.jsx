                  ...
                  <tr key={id} className="bg-white hover:bg-slate-100">
                    ...
                    >
                      <Link
                        role={"button"}
                        onClick={() => {
                          handleOrderAction(order.id, "approved");
                        }}
                        className="hover:text-green-500 text-transition duration-150 ease-in-out p-2 bg-white rounded-full shadow-md hover:shadow-lg w-8 h-8 text-center"
                      >
                      ...
                      <Link
                        ...
                        className="hover:text-red-700 transition duration-150 ease-in-out p-2 bg-white rounded-full shadow-md hover:shadow-lg w-8 h-8 text-center"
                      >
                      ...
                      {order.status == "approved" && (
                        <Link
                          role={"button"}
                          onClick={() => {
                            showReceiptForm(order, "approved");
                          }}
                          className="hover:text-yellow-400 text-transition duration-150 ease-in-out p-2 bg-white rounded-full shadow-md hover:shadow-lg w-8 h-8 text-center"
                        >
